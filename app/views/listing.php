...
<head>
  ...
  <title>Listing Page - Designed by Aryan</title>
...
<body>
  <nav id="navBar" class="navbar-white">
    ...
    <ul class="nav-links">
      ...
      <li><a href="listing.html" class="active">All Houses & Hostels</a></li>
    </ul>
  ...
  <div class="container">
    <div class="list-container">
      <div class="left-col">
        ...
        <div class="house">
          <div class="house-img">
            <img src="./assets/images/image-s2.png" />
          </div>
          <div class="house-info">
            <p>Private Villa in San Francisco</p>
            <h3>Deluxe Queen Room with Street View</h3>
        ...
        <div class="house">
          <div class="house-img">
            <img src="./assets/images/image-s3.png" />
          </div>
          <div class="house-info">
            <p>Private Villa in San Francisco</p>
            <h3>Deluxe Queen Room with Street View</h3>
        ...
        <div class="house">
          <div class="house-img">
            <img src="./assets/images/image-s4.png" />
          </div>
          <div class="house-info">
            <p>Private Villa in San Francisco</p>
            <h3>Deluxe Queen Room with Street View</h3>
        ...
        <div class="house">
          <div class="house-img">
            <img src="./assets/images/image-s5.png" />
          </div>
          <div class="house-info">
            <p>Private Villa in San Francisco</p>
            <h3>Deluxe Queen Room with Street View</h3>
        ...
        <div class="house">
          <div class="house-img">
            <img src="./assets/images/image-s6.png" />
          </div>
          <div class="house-info">
            <p>Private Villa in San Francisco</p>
            <h3>Deluxe Queen Room with Street View</h3>
