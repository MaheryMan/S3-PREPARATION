...
<body>
   ...
   <div class="login container grid" id="loginAccessRegister">
            ...
            <div class="login__social">
               ...
               <div class="login__social-links">
                  <a href="#" class="login__social-link">
                     <img src="<?= BASE_URL ?>/public/assets/images/icon-google.svg" alt="image" class="login__social-img">
                  </a>

                  <a href="#" class="login__social-link">
                     <img src="<?= BASE_URL ?>/public/assets/images/icon-facebook.svg" alt="image" class="login__social-img">
                  </a>

                  <a href="#" class="login__social-link">
                     <img src="<?= BASE_URL ?>/public/assets/images/icon-apple.svg" alt="image" class="login__social-img">
                  </a>
               </div>
            </div>
      ...
      <div class="login__register">
         ...
         <div class="login__area">
            <form action="<?= BASE_URL ?>/register" method="post" class="login__form">
               <div class="login__content grid">
